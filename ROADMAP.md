...
- [x] **Anomaly alerting** -- Detect and flag unusual patterns in session metrics (e.g., sudden test count drops, complexity spikes) (Session 29, PR #61)
...
- [x] **Awake Doctor** -- 13-check repo health diagnostic with A-F grade (Session 10)
