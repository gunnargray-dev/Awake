"""Tests for leaderboard.pipeline -- analysis pipeline."""
...
from leaderboard.pipeline import (
    _run_health,
    _run_complexity,
    _run_security,
    _run_dead_code,
...
class TestRunHealth:
    @patch("leaderboard.pipeline.analyze_health")
...
class TestRunComplexity:
    @patch("leaderboard.pipeline.analyze_complexity")
...
class TestRunSecurity:
    @patch("leaderboard.pipeline.audit_security")
...
class TestRunDeadCode:
    @patch("leaderboard.pipeline.find_dead_code")
...
class TestCloneRepo:
    @patch("leaderboard.pipeline.subprocess.run")
